#!/bin/bash
# Run llama-server in Docker with ROCm

MODEL="/models/lmstudio-backup/lmstudio-community/Qwen2.5-Coder-7B-Instruct-GGUF/Qwen2.5-Coder-7B-Instruct-Q4_K_M.gguf"
PORT=8080

echo "🦙 Starting llama-server with Qwen2.5-Coder-7B"
